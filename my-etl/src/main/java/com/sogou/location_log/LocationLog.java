package com.sogou.location_log;
 ...
 * 定位日志入口程序
 */
public class LocationLog implements Tool {
    ...
    private Job configureJob(String[] args) throws IOException {
        ...
        job.setJobName("etl:locationTm");
        job.setJarByClass(LocationLog.class);
        // 必需：指定mapper类
        job.setMapperClass(LocationLogMapper.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToolRunner.run(conf, new LocationLog(), args);
    }
